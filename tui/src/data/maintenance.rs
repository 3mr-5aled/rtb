    ...
    pub fn new() -> Self {
        let tasks = vec![
            MaintenanceTask {
                ...
                description: "Scans D: root directory to detect and report unauthorized ghost folders, temporary test directories, or non-standard root clutter. Ensures the strict 8-folder architecture is maintained.",
                target_info: "D:\\ Drive Root",
                flags_info: "-ReportOnly",
                script_path: "D:\\06-Tools\\scripts\\guard-d-drive.ps1",
                args: vec!["-ReportOnly"],
            ...
            MaintenanceTask {
                ...
                target_info: "02-Projects, 01-SandBox",
                flags_info: "-DryRun -DaysInactive 60",
                script_path: "D:\\06-Tools\\scripts\\clean-deps.ps1",
            ...
            MaintenanceTask {
                ...
                description: "Inspects all Git repositories across the drive. Checks for dirty working trees, uncommitted changes, unpushed commits, missing remotes, and stale branches older than 90 days.",
                target_info: "02-Projects, 01-SandBox, 03-Career",
                flags_info: "Full Health Diagnostics",
                script_path: "D:\\06-Tools\\scripts\\git-health.ps1",
                args: vec![],
                status: TaskStatus::Pending,
                duration_ms: 0,
            },
            MaintenanceTask {
                ...
                description: "Auto-generates a master markdown index (PROJECT-INDEX.md) cataloging all 36+ projects with status badges, detected tech stack frameworks, and last modified timestamps.",
                target_info: "D:\\02-Projects\\PROJECT-INDEX.md",
                flags_info: "UTF-8 Markdown Table",
                script_path: "D:\\06-Tools\\scripts\\project-index.ps1",
                args: vec![],
                status: TaskStatus::Pending,
                duration_ms: 0,
            },
            MaintenanceTask {
                ...
                description: "Safely searches for gitignored .env and .env.local secret files containing API keys and database credentials, creating a date-stamped backup in 08-Backup/env-secrets/.",
                target_info: "D:\\08-Backup\\env-secrets\\",
                flags_info: "Safe Recursive Scans",
                script_path: "D:\\06-Tools\\scripts\\backup-env-files.ps1",
                args: vec![],
                status: TaskStatus::Pending,
                duration_ms: 0,
            },
            MaintenanceTask {
                ...
                target_info: "D:\\08-Backup\\config-backups\\",
                flags_info: "Dotfiles, Terminal, Winget, WSL",
                script_path: "D:\\06-Tools\\scripts\\backup-configs.ps1",
                args: vec![],
                status: TaskStatus::Pending,
                duration_ms: 0,
            },
