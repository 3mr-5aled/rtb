...
### Changed
- fix(navigation): restore goto autocomplete and terminal cd switching across menu and shell

## [v0.13.6] - 2026-09-05

### Changed
- docs: adjust braille art spacing in core README

## [v0.13.5] - 2026-09-05

### Changed
- docs: update core README quick start and formatting

## [v0.13.4] - 2026-09-05

### Changed
- fix Windows PATHEXT collisions and preserve existing config during setup

## [v0.13.3] - 2026-09-05

### Changed
- preserve config when overwrite declined and make shell integration resilient
